...
describe('OriginalUrl', () => {
  ...
  describe('Invalid URLs', () => {
    it('should reject empty string', () => {
      ...
      expect(result.getErrorValue().message).toBe('URL cannot be empty.');
    });
    ...
    it('should reject URL with whitespace inside', () => {
      ...
      expect(result.isFailure).toBeTruthy();
      expect(result.getErrorValue()).toBeInstanceOf(InvalidUrlError);
      expect(result.getErrorValue().message).toBe(
    ...
    it('should reject URL without protocol', () => {
      ...
      expect(result.isFailure).toBeTruthy();
      expect(result.getErrorValue()).toBeInstanceOf(InvalidUrlError);
      expect(result.getErrorValue().message).toBe('URL is not valid.');
    });
